...
export default function Header() {
    return (
        <header className="bg-secondary w-full h-[80px] relative flex justify-center items-center">
            ...
            <Link to="/about" className="text-accent font-bold text-2xl hover:border-b border-b-accent ">About Us</Link>
            <Link to="/contact" className="text-accent font-bold text-2xl hover:border-b border-b-accent ">Contact Us</Link>
